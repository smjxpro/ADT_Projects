...
class FemaleHomeScreen extends StatefulWidget {
  const FemaleHomeScreen({Key? key}) : super(key: key);

  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<FemaleHomeScreen> {
                ...
                onTap: () {
                  ...
                  setState(() {
                    ...
                    if (_bmiResult > 25) {
                      ...
                      imagePath = 'assets/images/ffat.png';
                    } else if (_bmiResult >= 18.5 && _bmiResult <= 25) {
                      _textResult = "You have normal weight";
                      imagePath = 'assets/images/fperfect.png';
                    } else {
                      _textResult = "You're under weight";
                      imagePath = 'assets/images/fslim.png';
                    }
                  });
                },
                child: Text(
